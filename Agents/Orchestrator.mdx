...
- **Configuration:**
  ...
  - **Task Prompt**: Check for "extract.txt" File Existence:
    ...
    curl --location 'https://gen-v1.supervity.ai/api/v1/skill/automation/trigger/cmbrfbv0s002a4f1hw0fyaibg/cmbrfbv0s002b4f1hc046iwsz' \\
...
- **Configuration:**
  ...
  - **Task Prompt: **If the current directory contains extarct.txt file load the content from extract.txt file, and also pass the pdf attachment available from the current directory.
...
- **Configuration:**
  ...
  - **Task Prompt: **Check for "extract.txt" File Existence:
    ...
    curl --location 'https://gen-v1.supervity.ai/api/v1/skill/automation/trigger/cmbrf80sa001u4f1hvkwwt5em/cmbrf80sa001v4f1hro5m2sha' \\
